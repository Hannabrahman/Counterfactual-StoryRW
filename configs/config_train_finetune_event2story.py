...
max_seq_length = 164 #128
max_decoding_length = max_seq_length

np = 1
train_batch_size = 1 #2 * np #2 #8 #32
max_train_epoch = 10 #100
display_steps = 50 #20 # Print training loss every display_steps; -1 to disable
eval_steps = 500  #300  # Eval on the dev set every eval_steps; -1 to disable
sample_steps = -1
checkpoint_steps = 4000 #2000 # Checkpoint model parameters every checkpoint_steps;
                      # -1 to disable
...
feature_original_types = {
    ...
    "x1x2x4_ids": ["tf.int64", "FixedLenFeature", max_seq_length],
    "x1x2x4_len": ["tf.int64", "FixedLenFeature"],
    "x1x3_ids": ["tf.int64", "FixedLenFeature", max_seq_length],
    "x1x3_len": ["tf.int64", "FixedLenFeature"],
    "x1x3x4_ids": ["tf.int64", "FixedLenFeature", max_seq_length],
    "x1x3x4_len": ["tf.int64", "FixedLenFeature"],
    "x1x2x3_ids": ["tf.int64", "FixedLenFeature", max_seq_length],
    "x1x2x3_len": ["tf.int64", "FixedLenFeature"],
